...
FEATURES = ['ptp_amp', 'sharpness', 'ied_duration']  # your 3 features
X_shap = X_feat[FEATURES].copy()



final_model.fit(X_shap, y)   # IMPORTANT: fit on the same columns you'll explain
